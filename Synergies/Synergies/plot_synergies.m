...
str = 'Channel. ';
n_chan = 14;
muscle_str = {'Upper Trap', 'Middle Trap','Infraspinatus','Serratus Ant.',...
    'Ant. Deltoid','Mid. Deltoid','Post. Deltoid','Pect. Major','L.H. Triceps',...
    'S.H. Triceps','L.H. Biceps','S.H. Biceps','Wrist Ext.','Wrist Flx.'};
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%              GET THE SYNERGIES                 %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
...
colmap = {'Teal','Gold','GreenYellow','DarkOrange','DarkMagenta','FireBrick','Gray'};
str = 'Channel. ';
